            ...
            if (error === null) {
                if (writeFlag) {
                    ...
                    if (Object.keys(resp).length >= 4) {
                        fs.writeFileSync(`${__dirname}/write/myTest2/${elementId}.json`, JSON.stringify(resp, null, 4), 'utf8');
